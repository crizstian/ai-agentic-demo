...
def create_app():
    ...
    # FIXED: Insecure CORS vulnerability - now restricting to specific origins
    # Allow localhost for development and production domain
    allowed_origins = [
        "http://localhost:3000",
        "http://localhost:5000",
        "https://demobank.example.com"
    ]
    ...
    # FIXED: Reflected XSS vulnerability - now using HTML escaping
    @app.route("/welcome")
    def welcome():
